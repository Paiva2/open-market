        ...
        if (Objects.nonNull(offer.getOfferUserItems()) && !offer.getOfferUserItems().isEmpty()) {
            this.offerItems = offer.getOfferUserItems().stream().map(offerUserItem -> OfferItemOutput.builder()
                .item(ItemOutput.builder()
                    .id(offerUserItem.getItem().getId())
                    .externalId(offerUserItem.getItem().getExternalId())
                    .name(offerUserItem.getItem().getName())
                    .description(offerUserItem.getItem().getDescription())
                    .photoUrl(offerUserItem.getItem().getPhotoUrl())
                    .unique(offerUserItem.getItem().getUnique())
                    .baseSellingPrice(offerUserItem.getItem().getBaseSellingPrice())
                    .active(offerUserItem.getItem().getActive())
                    .build()
